...
from seahub.api2.endpoints.admin.share_links import AdminShareLink, \
        AdminShareLinkFileServerUrl, AdminShareLinkCheckPassword
from seahub.api2.endpoints.admin.upload_links import AdminUploadLink, \
        AdminUploadLinkFileServerUrl, AdminUploadLinkCheckPassword
...
urlpatterns = patterns(
    ...
    url(r'^api/v2.1/admin/share-links/(?P<token>[a-f0-9]+)/fileserver-url/$',
            AdminShareLinkFileServerUrl.as_view(), name='api-v2.1-admin-share-link-fileserver-url'),
    ...
    url(r'^api/v2.1/admin/upload-links/(?P<token>[a-f0-9]+)/fileserver-url/$',
            AdminUploadLinkFileServerUrl.as_view(), name='api-v2.1-admin-upload-link-fileserver-url'),
